...
<Popover open={popoverOpen} onOpenChange={(nextOpen) => (popoverOpen = nextOpen)} align="end">
	{#snippet trigger()}
		...
		>
			...
			{:else}
				<div class="flex size-full items-center justify-center rounded-full bg-primary text-xs font-semibold text-primary-foreground">
	...
	{#snippet children()}
		<div class="grid gap-4">
			...
			<div class="grid gap-2">
				...
				<div class="inline-flex w-fit items-center gap-1 rounded-full border border-border/70 bg-card/80 p-1">
