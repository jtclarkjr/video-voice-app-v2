...
<div class="min-h-screen">
  <a
    href="#main-content"
    class="sr-only fixed left-3 top-3 z-[60] rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground focus:not-sr-only"
  >
    Skip to content
  </a>
  <header class="relative z-20 border-b border-border/70 bg-background/85 backdrop-blur">
    ...
    >
      <nav
        class="flex min-w-0 items-center gap-3 text-sm font-bold tracking-[0.02em] text-foreground sm:gap-4"
        aria-label="Primary"
      >
        <a href="/">Home</a>
  ...
  <main id="main-content" tabindex="-1" class="px-3 py-6 sm:px-6 sm:py-14">
